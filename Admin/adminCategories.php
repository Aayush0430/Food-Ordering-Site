    ...
    <div class="body-main">
        ...
        <div id="category_add">
            ...
            <div class="cat-inner">
                <form action="addCategory.php" method="post">
                    ...
                    <input type="text" id="cat-image" name="category_image" placeholder="Image url" required>
            </div>
       ...
       while($item = mysqli_fetch_assoc($result))
       {
        $category_id=$item['category_id'];
          $sql_count="SELECT COUNT(item_id) as total FROM items where product_cat_id=$category_id";
