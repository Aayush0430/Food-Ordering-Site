...
<body>
    ...
    <div id="top" class="body-main">
     ...
     $count = 1;
     echo '<div id="all-products" style="width:80vw;margin-left:10px;min-height:82vh;">';
       echo '<div class="product-container"
       style="min-height:75vh;display:flex;justify-content:space-around;
          ...
          //  {
           ...
           echo'
               <div class="card my-4 box-food" style="width: 180px; height:250px;">
                   ...
                   <h6 class="card-title font-weight-bold" style="">Rs. '.$item['item_price'].'</h6>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <img src='.$item["item_image"].' class="card-img-top" style="height:100%;border-radius:15px;width:230px;object-fit: cover;object-position: center;">
