...
<body>
        ...
        <div id='second'>
            <div id='search'>
                <div>
                    <h1>Hungry?</h1>
                    <h4>
                        <p>You're in the rigth place</p>
                    </h4>
                    <a id="search-a" href="searchBypass.php#explore-section">
                        <div id='searchbar'>
                            <input id="input_search" type="text" readonly placeholder='Find your favourite food'
                                name="search">
    ...
    <div class="explore-page">
        ...
        $sql_cat_name="SELECT category_name from categories where category_id=$category_id";
        $result_cat=mysqli_query($conn,$sql_cat_name);
        $item=mysqli_fetch_assoc($result_cat);
        echo"
        <center>
            <h2 style='font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif'>".$item["category_name"].  "</h2>
        </center>";
              $sql = "SELECT * FROM `items` where product_cat_id=$category_id";
